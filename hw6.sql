...
BEGIN
    ...
    SELECT CASE
               WHEN local_time BETWEEN '12:00:00' AND '18:00:00' THEN 'Dobriy den'
               WHEN local_time BETWEEN '06:00:00' AND '12:00:00' THEN 'Dobroye utro'
               WHEN local_time BETWEEN '00:00:00' AND '06:00:00' THEN 'Lj,hjy no4i'
               ELSE 'Dobriy ve4er'
               END
    INTO result_text;
    RETURN result_text;
...
INSERT INTO lesson_4.users (firstname, lastname, email) VALUES ('John', 'Wick', 'chuca@example.tw');